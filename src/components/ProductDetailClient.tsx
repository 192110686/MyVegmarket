                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-end">
                    <div>
                      ...
                      <div className="text-[#1db954] text-[46px] font-black leading-none">
                        AED {myPrice.toFixed(2)}
                      </div>
                    </div>

                    <span className="text-xs bg-[#1db954]/15 text-[#1db954] font-black px-3 py-2 rounded-full">
                      SAVE 21%
                    </span>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="absolute right-0 top-0 bottom-0 w-1/2 opacity-70">
                    <svg viewBox="0 0 200 100" className="w-full h-full">
                      <path
                        d="M0,80 C40,30 80,90 120,50 C150,25 170,40 200,10"
                        fill="none"
                        stroke="#1db954"
                        strokeWidth="3"
                      />
